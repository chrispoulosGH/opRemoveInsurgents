...
const MISSIONS = [
  ...
  },
  {
    id: 6,
    code: 'OP-IRON FIST',
    title: 'TEHRAN REGIME STRIKE',
    type: 'STRATEGIC STRIKE — CRUISE MISSILE OPS',
    classification: 'EYES ONLY',
    location: 'TEHRAN METROPOLITAN AREA, IRN',
    assets: 'B-1B LANCER — JASSM CRUISE MISSILES',
    difficulty: 'CLASSIFIED',
    diffColor: '#9B59B6',
    briefing: [
      'By direct order of President Trump, all traces of Iran\'s oppressive Islamic regime are to be annihilated. Ten government facilities have been pre-selected for destruction.',
      'You are the weapons officer aboard a B-1B Lancer inbound from the Caspian Sea, heading south through the Alborz mountain passes toward Tehran.',
      'Remotely guide cruise missiles through the mountains to their targets. Active SAM networks are operational — stay low, avoid detection, and leave nothing standing.',
    ],
  },
];
